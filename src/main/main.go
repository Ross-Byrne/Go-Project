...
// struct for handling Post Object
type Post struct {
	Id           string
	ThreadPostId string
	Body         string
...
// Struct for handling array of Post objects
type Posts struct {
	Posts []Post
}

// struct for handling Thread Object
type Thread struct {
...
// struct for handling user login details
